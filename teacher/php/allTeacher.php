<?php
    ...
    if($name != ""){
    $consulta = $con->query( "select user, id, email, sala, photo, born, tuit from teacherAccount where '$name' = user" /*and private = 0"*/);
        ...
        $consulta = $con->query( "select user, id, email, sala from teacherAccount");
