        ...
        for(i = 0;i<aTuit.length;i++ ){
            ...
            "<div class='row'>"+
                ...
                "<div class='col-8 box-tuit' id='"+aTuit[i].id+"'> "+
                    ...
                    "<div><button class='retuit btn btn-link' width='16px' onclick='Retuit("+aTuit[i].id+")' data-toggle='modal' data-target='#addTuit'>Retuitear</button>  <span class='date'>"+aTuit[i].date+"</span></div> "+
                "</div>"+
                "<div class='col-2'></div>"+
            "</div>");
        }
